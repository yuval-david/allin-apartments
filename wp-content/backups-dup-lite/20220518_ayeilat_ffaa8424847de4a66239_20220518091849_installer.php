...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220518_ayeilat_ffaa8424847de4a66239_20220518091849_archive.zip';
	const ARCHIVE_SIZE		 = '35817944';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ffaa842-18091849';
    const SECONDARY_PACKAGE_HASH = 'ddacd5d-18091849';
	const VERSION			 = '1.4.5';
